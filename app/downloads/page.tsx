...
export const metadata = {
  title: "Downloads",
  description: "Download free Quranic resources, Tajweed guides, Six Kalimas, Namaz guides, and Ramadan planners in PDF format.",
};
      ...
      <section className="relative overflow-hidden bg-[var(--color-black-soft)] py-20 px-4 border-b border-[var(--color-border)]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-white leading-tight">
            Islamic <span className="text-[var(--color-accent)]">Downloads</span>
          </h1>
